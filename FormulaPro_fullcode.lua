...
addCat(17, "Analytical Chemistry", "Aqueous analytical chemistry relationships (no physics content)")

addCatVar(17, "A", "Absorbance", "unitless")
addCatVar(17, "M", "Molarity", "mol/L")
addCatVar(17, "M1", "Initial molarity", "mol/L")
addCatVar(17, "M2", "Final molarity", "mol/L")
addCatVar(17, "V", "Solution volume", "L")
addCatVar(17, "V1", "Initial volume", "L")
addCatVar(17, "V2", "Final volume", "L")
addCatVar(17, "T", "Transmittance", "unitless")
addCatVar(17, "c", "Analytical concentration", "mol/L")
addCatVar(17, "eps", "Molar absorptivity", "L/(mol*cm)")
addCatVar(17, "l", "Path length", "cm")
addCatVar(17, "m", "Mass of solute", "g")
addCatVar(17, "n", "Amount of substance", "mol")
addCatVar(17, "MW", "Molar mass", "g/mol")
addCatVar(17, "Hplus", "Hydrogen ion concentration", "mol/L")
addCatVar(17, "OHminus", "Hydroxide ion concentration", "mol/L")
addCatVar(17, "pH", "Acidity", "unitless")
addCatVar(17, "pOH", "Basicity", "unitless")
addCatVar(17, "pKa", "Acid dissociation constant (pKa)", "unitless")
addCatVar(17, "base", "Conjugate base concentration", "mol/L")
addCatVar(17, "acid", "Acid concentration", "mol/L")
addCatVar(17, "I", "Ionic strength", "mol/L")
addCatVar(17, "gamma", "Activity coefficient", "unitless")
addCatVar(17, "z", "Ionic charge", "unitless")
addCatVar(17, "Kf", "Overall formation constant", "unitless")
addCatVar(17, "Kfcond", "Conditional formation constant", "unitless")
addCatVar(17, "alphaY", "Fraction of EDTA as Y4-", "unitless")
addCatVar(17, "CEDTA", "EDTA concentration", "mol/L")
addCatVar(17, "VEDTA", "EDTA volume", "L")
addCatVar(17, "Canalyte", "Analyte metal concentration", "mol/L")
addCatVar(17, "Vanalyte", "Analyte sample volume", "L")
addCatVar(17, "KD", "Distribution coefficient", "unitless")
addCatVar(17, "D", "Distribution ratio", "unitless")
addCatVar(17, "Vaq", "Aqueous volume", "L")
addCatVar(17, "Vorg", "Organic volume", "L")
addCatVar(17, "q", "Fraction of analyte remaining in aqueous phase", "unitless")
addCatVar(17, "nextr", "Number of sequential extractions", "unitless")

addSubCat(17, 1, "Solutions and Dilutions", "Assumes ideal aqueous solutions")
aF(17, 1, "n=M*V", U("n","M","V"))
aF(17, 1, "M=n/V", U("M","n","V"))
aF(17, 1, "m=n*MW", U("m","n","MW"))
aF(17, 1, "M1*V1=M2*V2", U("M1","V1","M2","V2"))

addSubCat(17, 2, "Acid-Base Relationships", "Assumes water at 25"..utf8(176).."C")
aF(17, 2, "pH=-log(Hplus)/log(10)", U("pH","Hplus"))
aF(17, 2, "pOH=-log(OHminus)/log(10)", U("pOH","OHminus"))
aF(17, 2, "pH+pOH=14", U("pH","pOH"))
aF(17, 2, "pH=pKa+log(base/acid)", U("pH","pKa","base","acid"))

addSubCat(17, 3, "Spectrophotometry", "Assumes linear Beer-Lambert behavior")
aF(17, 3, "A=eps*l*c", U("A","eps","l","c"))
aF(17, 3, "T=10^(-A)", U("T","A"))
aF(17, 3, "A=-log(T)/log(10)", U("A","T"))

addSubCat(17, 4, "Activity Coefficients", "Debye-H\"uckel approximation, I<0.1 M")
aF(17, 4, "I=0.5*sum(c*z^2)", U("I","c","z"))
aF(17, 4, "log(gamma)=-0.51*z^2*sqrt(I)/(1+sqrt(I))", U("gamma","I","z"))

addSubCat(17, 5, "Complexometric Titrations", "1:1 metal-EDTA stoichiometry")
aF(17, 5, "n=CEDTA*VEDTA", U("n","CEDTA","VEDTA"))
aF(17, 5, "Canalyte=(CEDTA*VEDTA)/Vanalyte", U("Canalyte","CEDTA","VEDTA","Vanalyte"))
aF(17, 5, "Kfcond=Kf*alphaY", U("Kfcond","Kf","alphaY"))
aF(17, 5, "alphaY=Kfcond/Kf", U("alphaY","Kfcond","Kf"))

addSubCat(17, 6, "Liquid-Liquid Separations", "Neutral solute, distribution at equilibrium")
aF(17, 6, "D=KD", U("D","KD"))
aF(17, 6, "q=1/(1+D*(Vorg/Vaq))", U("q","D","Vorg","Vaq"))
aF(17, 6, "q=(1/(1+D*(Vorg/Vaq)))^nextr", U("q","D","Vorg","Vaq","nextr"))
